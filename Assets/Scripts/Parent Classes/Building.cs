...
public abstract class Building : SuperClass
{
    ...
    private void UpdateResourceInfo()
    {
        ...
        //if (_selfCount == 1)
        //{
        //    Resource.resourceInfoList = new List<ResourceInfo>()
        //        {
        //            new ResourceInfo(){ name = Type.ToString(), amountPerSecond=buildingContributionAPS }
        //        };

        //    for (int i = 0; i < Resource.resourceInfoList.Count; i++)
        //    {
        //        ResourceInfo resourceInfo = Resource.resourceInfoList[i];

        //        GameObject newObj = Instantiate(Resource.prefabResourceInfo, Resource.tformResourceTooltip);
        ...
        //        Resource.resourceInfoList[i] = resourceInfo;
        //    }
        //}
        //else if (_selfCount != 1)
        //{
        //    for (int i = 0; i < Resource.resourceInfoList.Count; i++)
        //    {
        //        ResourceInfo resourceInfo = Resource.resourceInfoList[i];
        ...
        //#region Working Edition
        //foreach (var resourceType in typesToModify.resourceTypesToModify)
        //{
        //    if (resourceType == ResourceType.Food && _selfCount == 1)
        //    {
        //        Food.resourceInfoList = new List<ResourceInfo>()
        //        {
        //            new ResourceInfo(){ name = Type.ToString(), amountPerSecond=buildingContributionAPS }
        //        };

        //        for (int i = 0; i < Food.resourceInfoList.Count; i++)
        //        {
        //            ResourceInfo resourceInfo = Food.resourceInfoList[i];

        //            GameObject newObj = Instantiate(Food.prefabResourceInfo, Food.tformResourceTooltip);
        ...
        //            Food.resourceInfoList[i] = resourceInfo;
        //        }
        //    }
        //    else if (resourceType == ResourceType.Food && _selfCount != 1)
        //    {
        //        for (int i = 0; i < Food.resourceInfoList.Count; i++)
        //        {
        //            ResourceInfo resourceInfo = Food.resourceInfoList[i];
